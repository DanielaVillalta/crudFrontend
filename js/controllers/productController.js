//Importamos servicios para comunicación con la API
import {
    getProducts,
    createProduct,
    updateProduct,
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //Botón "Agregar" resetea formulario y abre modal
    ...
    //Submit del formulario (Crear/Actualizar producto)
    ...
    //Resetear formulario (al agregar nuevo producto)
